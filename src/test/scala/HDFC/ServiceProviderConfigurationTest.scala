...
import HDFC.reader.mycomponent.MyStreamReaderImpl
import HDFC.transformer.mycomponent.MyStreamTransformerImpl
import HDFC.writer.mycomponent.MyStreamWriterImpl
